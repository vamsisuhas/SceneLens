...
class BLIP2SearchEngine:
        ...
        try:
            ...
            for i, segment in enumerate(relevant_segments[:top_k]):
                result = {
                    ...
                    "keyframe_path": segment.get('keyframe_path', f"blip2/{video['filename']}/{segment['frame_number']}"),
    ...
    def _analyze_frames_with_blip2(self, frames: List[Dict], query: str) -> List[Dict]:
            ...
            try:
                ...
                if self._is_frame_relevant(blip_response, query):
                    ...
                    segment = {
                        ...
                        'end_time': frame['timestamp_seconds'] + 1.0,  # 1 second duration
        ...
        # Sort by confidence
        relevant_segments.sort(key=lambda x: x['confidence'], reverse=True)
        
        # Group nearby segments
        grouped_segments = self._group_nearby_segments(relevant_segments)
